...
public class Constants {
    ...
    //0000 0000 0010 0000
    public static final int XY_BIT = 32;

    public static final int CAR_MASK = WALL_BIT | CAR_BIT | TIRE_BIT | POWERUP_BIT | BULLET_BIT;
    public static final int TIRE_MASK = WALL_BIT | CAR_BIT | TIRE_BIT | BULLET_BIT;
